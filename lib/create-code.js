...
const importName = (key, name) => {
  ...
  return new cst.types.ImportDeclaration([
    ...
    new cst.Token('Whitespace', ' '),
    new cst.types.ImportSpecifier([
      new cst.Token('Identifier', key) // Node expected but "Identifier" found
    ]),
    new cst.Token('Whitespace', ' '),
    new cst.Token('Identifier', 'from'),
    new cst.Token('Whitespace', ' '),
    new cst.Token('StringLiteral', name), // Node expected but "StringLiteral" found
    new cst.Token('Punctuator', ';')
  ]);
